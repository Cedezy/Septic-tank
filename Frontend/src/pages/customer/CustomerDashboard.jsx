                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-600">{formData.fullname || 'Not set'}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-600">{formatDate(formData.birthdate)}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="flex-1">
                                    <p className="text-sm font-medium text-gray-900">Complete Address</p>
                    ...
                    <div className="p-6">
                        <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-500">Manager your password</p>
                            </div>
                        </div>
                    </div>
                </div>
