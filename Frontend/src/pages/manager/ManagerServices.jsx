                            ...
                            {services.length === 0 ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                                    {services.map((service) => (
                                        <div  key={service._id}
                                            className='relative bg-white rounded-xl border-2 transition-all duration-300 group hover:shadow-lg
                                                ...
                                                <div className="relative w-full overflow-hidden rounded-t-xl h-48">
                                                    <div className="relative h-full w-full">
                                                        ...
                                                        <div className="flex transition-transform duration-300 ease-out"
                                                            style={{
                                                                transform: `translateX(-${service.carouselIndex || 0}00%)`
                                                            }}
                                                        >
