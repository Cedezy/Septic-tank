                    ...
                    <div className='flex flex-col gap-5 p-6'>
                        ...
                        <div ref={printRef} className="bg-white rounded-sm shadow-sm border border-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {filteredByTab.length === 0 ? (
                                        ...
                                        sortedBookings.map(booking => (
                                            <tr key={booking._id} className="even:bg-gray-50 odd:bg-white hover:bg-gray-100 ease-in-out duration-300">
                            ...
                            <div className="p-6 mt-10 print:block hidden">
                                {manager && (
                                    <div>
                                        <p className="text-sm text-gray-700">Prepared by: {manager.fullname}</p>
                                        <p>System Manager</p>
                                    </div>
                                )}
                            </div>
