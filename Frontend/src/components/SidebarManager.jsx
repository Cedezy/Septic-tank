...
const SidebarManager = ({ isCollapsed }) => {
    ...
    const menuItems = [
        { id: 'user-accounts', label: 'Registered User', icon: UserCheck, path: '/manager/users' },
        ...
        { id: 'services1', label: 'Services', icon: Wrench, path: '/manager/services1' },
        { id: 'about', label: 'About Us', icon: Info, path: '/manager/about' },
        { id: 'contact', label: 'Contact Us', icon: Phone, path: '/manager/contact' },
        { id: 'faqs', label: 'FAQs', icon: HelpCircle, path: '/manager/faqs' },
        { id: 'my-account', label: 'My Account', icon: UserCog, path: '/manager/account' },
        {
            id: 'sys-settings',
            ...
            submenu: [
                ...
                { label: 'Gallery', path: '/manager/gallery' },
            ],
        },
    ];
        ...
        <div className="fixed flex h-screen bg-gray-50">
            <div className={`bg-white shadow-xl transition-all duration-300 ease-in-out ${isCollapsed ? 'w-16' : 'w-72'} flex flex-col`}>
                <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                    <div>
                        {!isCollapsed && (
                            <h1 className="text-xl font-bold tracking-widest uppercase text-gray-800">Welcome manager!</h1>
                        )}
